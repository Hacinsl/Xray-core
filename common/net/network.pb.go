...
const (
	Delivery_Unspecified Delivery = 0
	Delivery_Stream      Delivery = 1
	Delivery_Packet      Delivery = 2
	Delivery_Unix        Delivery = 3
)
...
func (Delivery) Descriptor() protoreflect.EnumDescriptor {
	return file_common_net_network_proto_enumTypes[1].Descriptor()
}

func (Delivery) Type() protoreflect.EnumType {
	return &file_common_net_network_proto_enumTypes[1]
}
...
func (Delivery) EnumDescriptor() ([]byte, []int) {
	return file_common_net_network_proto_rawDescGZIP(), []int{1}
}
...
var file_common_net_network_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_common_net_network_proto_goTypes = []any{
	...
	(Delivery)(0),       // 1: xray.common.net.Delivery
	(*NetworkList)(nil), // 2: xray.common.net.NetworkList
}
