...
type TransportConfig struct {
	...
	// Specific transport method settings.
...
func (x *TransportConfig) GetMethodName() string {
	if x != nil {
		return x.MethodName
	}
	return ""
...
func (x *StreamConfig) GetMethodName() string {
	if x != nil {
		return x.MethodName
	}
	return ""
...
const file_transport_internet_config_proto_rawDesc = "" +
	"\n" +
	"\x1ftransport/internet/config.proto\x12\x17xray.transport.internet\x1a!common/serial/typed_message.proto\x1a\x18common/net/address.proto\"p\n" +
	"\x0fTransportConfig\x12\x1f\n" +
	"\vmethod_name\x18\x03 \x01(\tR\n" +
	"methodName\x12<\n" +
	"\bsettings\x18\x02 \x01(\v2 .xray.common.serial.TypedMessageR\bsettings\"\xd9\x04\n" +
	"\fStreamConfig\x125\n" +
	"\aaddress\x18\b \x01(\v2\x1b.xray.common.net.IPOrDomainR\aaddress\x12\x12\n" +
	"\x04port\x18\t \x01(\rR\x04port\x12\x1f\n" +
